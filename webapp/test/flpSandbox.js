		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#spoolsassetdisposaltask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"spoolsassetdisposaltask-display": {
								"semanticObject": "spoolsassetdisposaltask",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=spoolsassetdisposaltask",
									"url": sap.ui.require.toUrl("spoolsassetdisposaltask")
								}
							}
						}
					}
